...
- For prose documentation (README, MkDocs pages), follow the [documentation style guide](docs/style-guide.md): formatting, tone, terminology, headings, linking, and American English spelling.
